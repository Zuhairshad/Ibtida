        ...
        <View style={{ borderWidth: 1, borderColor: colors.cardBorder, borderRadius: 24, backgroundColor: '#FFFFFF', overflow: 'hidden' }}>
          ...
          <View style={{ padding: 18, borderBottomWidth: 1, borderColor: colors.cardBorder, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
            ...
            <View style={{ flexDirection: 'row', gap: 8 }}>
              <PressableScale onPress={targetDown} scaleTo={0.9} style={{ width: 44, height: 44, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(23,32,28,0.1)', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: 19, color: colors.inkMuted }}>−</Text>
              </PressableScale>
              <PressableScale onPress={targetUp} scaleTo={0.9} style={{ width: 44, height: 44, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(23,32,28,0.1)', backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' }}>
                <Text style={{ fontSize: 19, color: colors.inkMuted }}>+</Text>
              </PressableScale>
            </View>
          </View>
          ...
          <View style={{ padding: 18, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
            <View>
              ...
              <Text style={{ fontSize: 17, fontWeight: '500', color: colors.inkStrong, marginTop: 9 }}>8:00 PM</Text>
            </View>
